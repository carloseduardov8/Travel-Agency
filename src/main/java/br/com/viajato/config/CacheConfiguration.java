...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(br.com.viajato.domain.Seguradora.class.getName() + ".seguros", jcacheConfiguration);
            cm.createCache(br.com.viajato.domain.Contrato.class.getName(), jcacheConfiguration);
            cm.createCache(br.com.viajato.domain.Compra.class.getName(), jcacheConfiguration);
            cm.createCache(br.com.viajato.domain.Compra.class.getName() + ".passagems", jcacheConfiguration);
            cm.createCache(br.com.viajato.domain.Compra.class.getName() + ".locacaos", jcacheConfiguration);
            cm.createCache(br.com.viajato.domain.Compra.class.getName() + ".reservas", jcacheConfiguration);
            cm.createCache(br.com.viajato.domain.Compra.class.getName() + ".contratoes", jcacheConfiguration);
            cm.createCache(br.com.viajato.domain.Passagem.class.getName(), jcacheConfiguration);
            cm.createCache(br.com.viajato.domain.Seguro.class.getName(), jcacheConfiguration);
            cm.createCache(br.com.viajato.domain.Seguro.class.getName() + ".contratoes", jcacheConfiguration);
