    ...
    describe('Compra Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/compras';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Compra', () => {
                service.create(new Compra(null)).subscribe(received => {
            ...
            it('should update a Compra', () => {
                service.update(new Compra(123)).subscribe(received => {
