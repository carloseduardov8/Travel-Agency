    ...
    describe('Seguro Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/seguros';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Seguro', () => {
                service.create(new Seguro(null)).subscribe(received => {
            ...
            it('should update a Seguro', () => {
                service.update(new Seguro(123)).subscribe(received => {
